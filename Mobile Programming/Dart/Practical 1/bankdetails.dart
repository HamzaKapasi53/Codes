  ...
  void withdrawal(int wit){
    if(bankbalance>wit){
       if((bankbalance-wit)<=5000){
         print("YOU CAN'T WITHDRAW THE MONEY AS MINIMUM BALANCE OF 5000 IS REQUIRED");
       }
    
//     not included else{
        if(bankbalance>wit){
          bankbalance=bankbalance - wit;
          print("ACCOUNT HOLDER'S BANK BALANCE AFTER WITHDRAWING : ${bankbalance}");
...
void main(){
  bank obj=bank();
  obj.name="HAMZA KAPASI";
  obj.accountno=54546430;
